...
public class BigIntTest {
	...
	@Test
	public void testConstructorsAndToString() throws BigIntFormatException {
		// BigInt(String)
	...
	@Test
	public void testEquals() throws BigIntFormatException {
		// some random tests
	...
	@Test
	public void testCompareTo() throws BigIntFormatException {
		// some random tests
		BigInt maxLong = new BigInt(Long.MAX_VALUE);
		for (int i = 1; i <= 20; i++) {
	...
	@Test
	public void testAdd() throws BigIntFormatException {
		// some random tests
		for (int i = 1; i <= 20; i++) {
			...
			// System.out.println(b.add(c) + ":" + new BigInt(i1 + i2));
	...
	@Test
	public void testSubtract() throws BigIntFormatException {
		// some random tests
		for (int i = 1; i <= 20; i++) {
			long i1 = rand.nextInt();
			long i2 = rand.nextInt();
	...
	@Test
	public void testMultiplyAndFactorial() throws BigIntFormatException {
		// some random tests
		for (int i = 1; i <= 20; i++) {
			long i1 = rand.nextInt();
			long i2 = rand.nextInt();
	...
	@Test
	public void testToString2s() throws BigIntFormatException {
		// some random tests
		
//		BigInt fact100 = new BigInt(
//				"");
////
//		BigInt x = new BigInt(1000);
